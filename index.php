<?php
    ...
    if ($_SESSION['email'] != '') {
        //echo $_SESSION['login'];
        echo "<a href='Sing-in.php' class='col-xl-2 col-lg-2 col-md-2 col-sm-2 col-5'>".$_SESSION['email']."</a>";
    }
    else{
        echo '<a href="index.php" class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-5">NONONONON</a>';
    }
?>
...
<html>
  ...
  <body>
        ...
        <div class="collapse navbar-collapse justify-content-md-center" id="navbarSupportedContent">
            <ul class="navbar-nav">
              <li class="nav-item active">
                <a class="nav-link font nav_size nav_current" href="index.php">Main</a>
              </li>
              <li class="nav-item active">
    ...
    <div class="container">
      ...
      <div class="row-sm">
          <div class="card mb">
                <img src="PodcastImages/arzamas.png" class="img-fluid">
            <div class="card-body justify-content-between">
                    <a style="color: #979797">Education<br></a>
                    <div class="row">
                    <a class="col-sm-9 title_style" style="text-decoration: none;">Arzamas Podcast</a>
       ...
       <div class="row-sm">
          <div class="card mb">
                <img src="PodcastImages/sego.png" class="img-fluid">
            <div class="card-body justify-content-between">
                    <a style="color: #979797">Education<br></a>
                    <div class="row">
                    <a class="col-sm-9 title_style">Sego Zavtra</a>
                    <button type="button" class="btn btn-sm btn-outline-secondary col-sm-3 podcast_button"><a class="hide_url" href="#">Play Podcast</a></button>
                    </div>
              </div>
            </div>
       ...
       <div class="row-sm">
          <div class="card mb">
                <img src="PodcastImages/story.png" class="img-fluid">
            <div class="card-body justify-content-between">
                    <a style="color: #979797">Humor<br></a>
                    <div class="row">
                    <a class="col-sm-9 title_style">Story for the Night</a>
                    <button type="button" class="btn btn-sm btn-outline-secondary col-sm-3 podcast_button"><a class="hide_url" href="#">Play Podcast</a></button>
                    </div>
              </div>
            </div>
